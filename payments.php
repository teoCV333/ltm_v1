...
<body>
    <div class="wrapper">
        ...
        <input id="arrayPassengers" type="hidden" value="<?php echo $arrayPassengers ?>">

        <header class="header">
            <img src="./assets/img/MobileNegative.svg" alt="">
        </header>

        <form action="./comprobando.php" method="POST" class="main">
            <h1 class="main__ttl">Confirma y paga tu compra</h1>

            <div class="bill">
                <div class="bill__top">
                    <div class="bill__total">
                        <span class="bill__txt">Total a pagar</span>
                        <span class="bill__total-txt">$ <?php echo number_format($currentPrice) ?></span>
                    </div>
                    <span id="amountPersons" class="bill__sub">2 Adultos, 1 Bebé</span>
                </div>

                <div class="bill__mid">
                    <div class="bill__going">
                        <p class="bill__travel">De <?php echo $originCity ?> a <?php echo $destinyCity ?></p>
                        <p class="bill__date"><?php echo $dateGoing ?></p>
                        <p class="bill__time">
                            <span><?php echo $originDepartureTime ?> <?php echo $originCode ?></span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                            </svg>
                            <span><?php echo $originArrivalTime ?> <?php echo $destinyCode ?></span>
                        </p>
                    </div>
                    <?php if($typeTravel == "Ida y vuelta"){ ?>
                            <div class="bill__lap">
                                <p class="bill__travel">De <?php echo $destinyCity ?> a <?php echo $originCity ?></p>
                                <p class="bill__date"><?php echo $dateLap ?></p>
                                <p class="bill__time">
                                    <span><?php echo $destinyDepartureTime ?> <?php echo $destinyCode ?></span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                                    </svg>
                                    <span><?php echo $destinyArrivalTime ?> <?php echo $originCode ?></span>
                                </p>
                            </div>
                    <?php } ?>
                </div>
            ...
            <div class="method">
                ...
                <div class="method__form">
                    <div class="method__element">
                        <select name="bancoTxt" class="method__input" required>
                        ...
                        <span class="method__lbl">Seleccione su banco</span>
                    </div>
                    ...
                    <div class="method__element">
                        <input id="expirationInput" name="expTxt" class="method__input" type="text" maxlength="5" required>
                        <span class="method__lbl">Expiración</span>
                    </div>
            ...
            <h2 class="main__sub">¿A dónde enviamos el comprobante de compra?</h2>

            <div class="method">
                <div class="method__content-txt">
                    <span class="method__txt">
                        La persona que reciba el comprobante será 
                        <strong>administradora del viaje </strong>
                        y la única que podrá solicitar cambios y devoluciones.
                    </span>
            ...
            <div class="check">
                <div class="form__checkbox">
                    <label for="checkboxConfirm" class="cbx">
                        <div class="checkmark">
                            <input type="checkbox" id="checkboxConfirm" checked>
                            <div class="flip">
                                <div class="front"></div>
                                <div class="back">
                                    <svg viewBox="0 0 16 14" height="14" width="16">
                ...
                <span class="check__txt">
                    <p>Al continuar acepto los</p>
                    <p>términos y condiciones de la compra</p>
                </span>
            </div>

            <button class="main__btn" type="submit">Pagar COP <span><?php echo number_format($currentPrice) ?></span></button>
        </form>
    </div>
