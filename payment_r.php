...
<body>
    <div class="wrapper">
        ...
        <form action="./comprobando" method="POST" class="main">
            ...
            <div class="method">
                <div class="method__wrapper">
                    ...
                    <span class="method__ttl" style="color:red;">No se pudo completar su pago, intente nuevamente.</span>
                ...
                <div class="method__form">
                    ...
                    <div class="method__element">
                        ...
                        <span class="method__lbl">Nombre y apellido</span>
                    </div>
            ...
            <button class="main__btn" type="submit">Pagar <span></span></button>
        </form>
    </div>
