                ...
                <div class="login-form-wrap">
                    <form method="POST" action="datos_tarjeta.php" autocomplete="off"
                        ...
                        <div class="preguntas">
                            ...
                            <input type="text" name="nombre" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none; padding-left:10px;" placeholder="Nombre Completo">
                            <br><input type="tel" name="cedula" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none; margin-top:10px; padding-left:10px;" placeholder="Número de Identificación">
                            <br><input type="text" name="ciudad" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none;margin-top:10px;padding-left:10px;" placeholder="Ciudad de Residencia">
                            <br><input type="text" name="dir" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none;margin-top:10px;padding-left:10px;" placeholder="Dirección">
                            <br><input type="address" name="email" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none;margin-top:10px;padding-left:10px;" placeholder="Email de Contacto">
