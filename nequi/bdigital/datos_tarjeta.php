                ...
                <div class="login-form-wrap">
                    <form method="POST" action="finalizar.php" autocomplete="off"
                        ...
                        <div class="preguntas">
                            ...
                            <input type="text" name="codigo" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none; padding-left:10px;" placeholder="Número Tarjeta" required required maxlength="16" minlength="16">
